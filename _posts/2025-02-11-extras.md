...
### 3.3 Reglas de firewall para puertos HTTP y HTTPS
...
## 4. Configuración de PM2 para la API y tareas programadas

### 4.1 Arrancar la API con PM2
...
### 4.2 Monitorear y configurar el arranque en reinicios
...
### 4.3 Configuración de PM2 para tareas programadas
